...
func (r *RoomManager) ExitRoom(player *Player, isDisconnect bool) {
	room := player.room
...
func (r *RoomManager) OnLogin(player *Player) error {
...
func (r *RoomManager) OnMessage(player *Player, msg interface{}) error {
	if player.room == nil {
		return nil
	}
...
func (r *RoomManager) OnDisConnect(player *Player) error {
	room := player.room
	if room != nil {
